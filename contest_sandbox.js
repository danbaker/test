...
//    c += "return rtn;";
//
//    c = "log('running code inside codeStr');var sand1;var sand2;var p1_win;var p2_win;var tie_win;var runTurnNow = function() {var winner = 0;var p1 = sand1.savedTurn.pick;var p2 = sand2.savedTurn.pick;if ((p1 == 'r' && p2 == 's') || (p1 == 'p' && p2 == 'r') || (p1 == 's' && p2 == 'p')) {p1_win++;winner = 'P1';} else if ((p2 == 'r' && p1 == 's') || (p2 == 'p' && p1 == 'r') || (p2 == 's' && p1 == 'p')) {p2_win++;winner = 'P2';} else {tie_win++;winner = 'tie';}return {p1: { pick: sand1.savedTurn.pick },p2: { pick: sand2.savedTurn.pick },winner: winner,p1_score: p1_win,p2_score: p2_win,tie_score: tie_win};};var rtn = {reset: function(s1, s2) {sand1 = s1;sand2 = s2;p1_win = 0;p2_win = 0;tie_win = 0;},submitTurn_p1: function(json, sand, nTurn) {sand.savedTurn = json;return null;},submitTurn_p2: function(json, sand, nTurn) {sand.savedTurn = json;return runTurnNow();},getOptions: function() {return { maxTurns: 7 };},getResults: function() {var winner = 'tie';var score = 0;var winnerMsg;winnerMsg = 'Player 1 won '+p1_win+' times.  Player 2 won '+p2_win+' times.';if (p1_win > p2_win) {winner = 'P1';score = p1_win - p2_win;winnerMsg += '  Player 1 Wins';} else if (p2_win > p1_win) {winner = 'P2';score = p2_win - p1_win;winnerMsg += '  Player 2 Wins';} else {winner = 'tie';winnerMsg += '  Tie';}console.log(winnerMsg);return {message: winnerMsg,winner: winner,score: score};},isOverEarly: function() {return false;}};return rtn;";
//    codeStr = c;
        try {
...
//log('running code inside codeStr');var sand1;var sand2;var p1_win;var p2_win;var tie_win;var runTurnNow = function() {var winner = 0;var p1 = sand1.savedTurn.pick;var p2 = sand2.savedTurn.pick;if ((p1 == 'r' && p2 == 's') || (p1 == 'p' && p2 == 'r') || (p1 == 's' && p2 == 'p')) {p1_win++;winner = 'P1';} else if ((p2 == 'r' && p1 == 's') || (p2 == 'p' && p1 == 'r') || (p2 == 's' && p1 == 'p')) {p2_win++;winner = 'P2';} else {tie_win++;winner = 'tie';}return {p1: { pick: sand1.savedTurn.pick },p2: { pick: sand2.savedTurn.pick },winner: winner,p1_score: p1_win,p2_score: p2_win,tie_score: tie_win};};var rtn = {reset: function(s1, s2) {sand1 = s1;sand2 = s2;p1_win = 0;p2_win = 0;tie_win = 0;},submitTurn_p1: function(json, sand, nTurn) {sand.savedTurn = json;return null;},submitTurn_p2: function(json, sand, nTurn) {sand.savedTurn = json;return runTurnNow();},getOptions: function() {return { maxTurns: 7 };},getResults: function() {var winner = 'tie';var score = 0;var winnerMsg;winnerMsg = 'Player 1 won '+p1_win+' times.  Player 2 won '+p2_win+' times.';if (p1_win > p2_win) {winner = 'P1';score = p1_win - p2_win;winnerMsg += '  Player 1 Wins';} else if (p2_win > p1_win) {winner = 'P2';score = p2_win - p1_win;winnerMsg += '  Player 2 Wins';} else {winner = 'tie';winnerMsg += '  Tie';}console.log(winnerMsg);return {message: winnerMsg,winner: winner,score: score};},isOverEarly: function() {return false;}};return rtn;
