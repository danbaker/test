        ...
        if (!doc || typeof doc !== "object") {
            ...
            try {
                ...
                if (!doc.contest_id) {
                    ...
                    utdb.getDoc(utdb.collection_contests(), "contests", doc.contest_id, function(contestDoc) {
                        if (!contestDoc) {
                            helper.sendJson(res, {response:false, message:"POST bot failed. contest_id("+doc.contest_id+") not found"});
                        } else {
